...
export abstract class Component<T> {
   ...
   * @param message the Message object
   */
  abstract onMessageCreateWithGuildPrefix(
    args: string[],
    message: Message,
  ): Promise<void>;
   ...
   */
  abstract onMessageReactionRemove(
    messageReaction: MessageReaction,
    user: User,
  ): Promise<void>;
