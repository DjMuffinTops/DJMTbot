...
import {DisTubeManager} from './DisTubeManager';
...
export class DJMTbot {
  ...
  client: Client;
  distube: DisTube;
  private readonly disTubeManager: DisTubeManager;
  ...
  private constructor() {
    ...
    this.disTubeManager = new DisTubeManager(this.client);
    this.distube = this.disTubeManager.player;
