...
export class DJMTbot {
  ...
  private constructor() {
    ...
    this.initGuildInstancesFromFiles().then((r) =>
      console.log(`${this.guilds.size} DJMT Guilds Initialized`),
    );
  }
  ...
  async run() {
    ...
    this.client.on(Events.GuildMemberAdd, async (member) => {
      ...
      if (guild) {
        ...
        console.log(
          `member does not have an associated guild instance: ${member}`,
        );
      }
    });
    ...
    this.client.on(Events.MessageCreate, async (message: Message) => {
      ...
      if (guild) {
        ...
        console.log(
          `Message does not have an associated guild instance: ${message}`,
        );
      }
    });
    ...
    this.client.on(Events.MessageUpdate, async (oldMessage, newMessage) => {
      ...
      if (guild) {
        ...
        console.log(
          `NewMessage does not have an associated guild instance: ${newMessage}`,
        );
      }
    });
    ...
    this.client.on(Events.VoiceStateUpdate, async (oldState, newState) => {
      ...
      if (guild) {
        ...
        console.log(
          `newState does not have an associated guild instance: ${newState}`,
        );
      }
    });
    ...
    this.client.on(Events.MessageReactionAdd, async (messageReaction, user) => {
      ...
      if (!messageReaction.partial && guild) {
        ...
        console.log(
          `Reaction does not have an associated guild instance: ${messageReaction}`,
        );
      }
    });
    ...
    this.client.on(Events.InteractionCreate, async (interaction) => {
      ...
      if (guild) {
        ...
        console.log(
          `Interaction does not have an associated guild instance: ${interaction}`,
        );
      }
    });
